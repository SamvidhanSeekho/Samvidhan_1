...
export const tiles = [
    ...
    { name: 'Right to Freedom', type: 'right', category: 'rights', question: 'Which of these is NOT part of the Right to Freedom under Article 19?', options: ['Freedom of speech', 'Assemble peacefully', 'Form associations', 'Right to strike and disrupt'], answer: 3, points: 10 },
    ...
    { name: 'Right against Exploitation', type: 'right', category: 'rights', question: 'This right prohibits human trafficking and forced labor.', options: ['Right to Freedom', 'Right against Exploitation', 'Equality Right', 'Cultural Rights'], answer: 1, points: 10 },
    { name: 'Amendment Zone', type: 'corner', corner: 'amendment' },
    { name: 'Parliament', type: 'institution', category: 'institutions', question: 'The Parliament of India consists of the President and which two houses?', options: ['Lok Sabha and Vidhan Sabha', 'Lok Sabha and Rajya Sabha', 'Rajya Sabha and State Council', 'House of Commons and House of Lords'], answer: 1, points: 12, penalty: 6 },
    { name: 'Civic Challenge', type: 'challenge' },
    ...
    { name: 'Remedies Right', type: 'right', category: 'rights', question: 'Which article is called the "heart and soul" of the Constitution as it allows citizens to move the court if their rights are violated?', options: ['Article 14', 'Article 19', 'Article 32', 'Article 51A'], answer: 2, points: 10 },
    { name: 'Election Commission', type: 'institution', category: 'institutions', question: 'What is the main function of the Election Commission of India?', options: ['To count votes', 'To conduct free and fair elections', 'To select candidates', 'To fund political parties'], answer: 1, points: 12, penalty: 6 },
    { name: 'Quit India Movement', type: 'event', category: 'events', question: 'In which year did the Quit India Movement, a major milestone in the freedom struggle, begin?', options: ['1920', '1930', '1942', '1947'], answer: 2, points: 15, penalty: 5 },
    { name: 'Scientific Temper', type: 'duty', category: 'duties', question: 'Developing scientific temper, humanism, and the spirit of inquiry and reform is a fundamental duty. True or False?', options: ['True', 'False'], answer: 0, points: 8, penalty: 4 },
    { name: 'Civic Challenge', type: 'challenge' },
    { name: 'Cultural Rights', type: 'right', category: 'rights', question: 'These rights protect the interests of which groups?', options: ['All citizens', 'Only the majority community', 'Religious and linguistic minorities', 'Only foreign visitors'], answer: 2, points: 10 },
    { name: 'Free Parking', type: 'corner', corner: 'parking' },
    { name: 'Right to Information', type: 'right', category: 'rights', question: 'The RTI Act allows citizens to access information from...', options: ['Private companies', 'Public authorities (government bodies)', 'Foreign embassies', 'Only the courts'], answer: 1, points: 10 },
    { name: 'Guard Public Property', type: 'duty', category: 'duties', question: 'Damaging public property like buses or monuments violates a fundamental duty. True or False?', options: ['True', 'False'], answer: 0, points: 8, penalty: 4 },
    { name: 'President of India', type: 'institution', category: 'institutions', question: 'Who is the constitutional head of the Republic of India?', options: ['Prime Minister', 'Chief Justice', 'President', 'Speaker of Lok Sabha'], answer: 2, points: 12, penalty: 6 },
    { name: 'Dandi March', type: 'event', category: 'events', question: 'The Dandi March, led by Mahatma Gandhi, was a protest against the tax on what?', options: ['Tea', 'Cotton', 'Salt', 'Land'], answer: 2, points: 15, penalty: 5 },
    { name: 'Civic Challenge', type: 'challenge' },
    ...
    { name: 'Abide by Constitution', type: 'duty', category: 'duties', question: 'The very first fundamental duty listed in the Constitution is to...', options: ['Pay taxes', 'Vote regularly', 'Abide by the Constitution and respect its ideals', 'Serve in the army'], answer: 2, points: 8, penalty: 4 },
    { name: 'Panchayati Raj', type: 'institution', category: 'institutions', question: 'Panchayati Raj refers to the system of local self-government in which area?', options: ['Urban areas', 'Rural areas', 'Metropolitan cities', 'Union Territories'], answer: 1, points: 12, penalty: 6 },
    { name: 'First General Election', type: 'event', category: 'events', question: 'India held its first-ever general elections in which period?', options: ['1947-48', '1951-52', '1961-62', '1971-72'], answer: 1, points: 15, penalty: 5 },
    { name: 'Go to Challenge', type: 'corner', corner: 'go_to_challenge' },
    { name: 'Right to Freedom of Religion', type: 'right', category: 'rights', question: 'This right allows citizens to profess, practice, and propagate any religion of their choice. True or False?', options: ['True', 'False'], answer: 0, points: 10 },
    { name: 'Strive for Excellence', type: 'duty', category: 'duties', question: 'To strive towards excellence in all spheres of individual and collective activity is a...', options: ['Fundamental Right', 'Directive Principle', 'Fundamental Duty', 'Preamble goal'], answer: 2, points: 8, penalty: 4 },
    { name: 'Civic Challenge', type: 'challenge' },
    { name: 'Reserve Bank of India', type: 'institution', category: 'institutions', question: 'Which institution is responsible for issuing currency and regulating India\'s financial system?', options: ['State Bank of India', 'Ministry of Finance', 'NITI Aayog', 'Reserve Bank of India'], answer: 3, points: 12, penalty: 6 },
    { name: 'Green Revolution', type: 'event', category: 'events', question: 'The Green Revolution in India primarily increased the production of which food grains?', options: ['Pulses and millets', 'Fruits and vegetables', 'Rice and wheat', 'Oilseeds'], answer: 2, points: 15, penalty: 5 },
    { name: 'Provide Education Opportunity', type: 'duty', category: 'duties', question: 'It is a duty for a parent or guardian to provide opportunities for education to their child between the ages of 6 and 14. True or False?', options: ['True', 'False'], answer: 0, points: 8, penalty: 4 },
    { name: 'Civic Challenge', type: 'challenge' },
    ...
    { name: 'NITI Aayog', type: 'institution', category: 'institutions', question: 'NITI Aayog replaced which former body as the premier policy think tank of the Indian government?', options: ['Finance Commission', 'Planning Commission', 'Law Commission', 'Election Commission'], answer: 1, points: 12, penalty: 6 },
];
